...
public class FractionTest {
    public static void main(String[] args) {
        ...
        System.out.println("Textový řetězec:\t" + fractionString.toString());
        System.out.println();
        ...
        System.out.println("Textový řetězec:\t" + fractionStringFull.toString());
        System.out.println();
        ...
        System.out.println("Textový řetězec:\t" + fraction.toString());
        System.out.println();
        ...
        System.out.println("Textový řetězec:\t" + fractionFull.toString());
    }
}
